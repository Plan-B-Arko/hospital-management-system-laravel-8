                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($nurses as $nurse)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset($nurse->image) }}" class="rounded avatar-lg"
                                                    ...
                                                    <td>{{ $nurse->mobile }}</td>
                                                    <td>{{ $nurse->gender }}</td>
                                                    <td>{{ $nurse->user_role }}</td>
                                                    <td>{{ $nurse->created_at }}</td>
                                                    <td>{{ $nurse->status }}</td>
                                                    <td>
                                                        <button type="button" value="{{ $nurse->id }}"
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.nurse.status == 'active') {
