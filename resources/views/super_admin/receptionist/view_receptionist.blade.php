                                        ...
                                        aria-describedby="datatable-buttons_info">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($receptionists as $receptionist)
                                                    <tr>
                                                        <td>{{ $sn++ }}</td>
                                                        <td>{{ $receptionist->name }}
                                                        </td>
                                                        <td>
                                                            <img src="{{ asset($receptionist->image) }}" class="rounded avatar-lg"
                                                            alt="" style="width: 80px;">
                                                        </td>
                                                        <td>{{ $receptionist->email }}</td>
                                                        <td>{{ $receptionist->mobile }}</td>
                                                        <td>{{ $receptionist->gender }}</td>
                                                        <td>{{ $receptionist->user_role }}</td>
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#user_role').val(response.receptionist.user_role);
                        $('#receptionist_id').val(response.receptionist.id);
                        $('#name').val(response.receptionist.name);
                        $('#email').val(response.receptionist.email);
                        $('#phone').val(response.receptionist.mobile);
                        $('#address').val(response.receptionist.address);
                        $('#status').val(response.receptionist.status);
                        if (response.receptionist.gender == 'male') {
                        ...
                        if (response.receptionist.status == 'active') {
